...
class _MyInvestmentState extends State<MyInvestment>
{
  ...
  [
    [1.0, 0.3, 0.7, 0.6, 0.55, 0.8, 1.2, 1.3, 1.35, 0.9, 1.5, 1.7, 5.8, 1.7, 1.2, 0.8, 1.9, 2.0, 2.2, 1.9, 2.2, 2.1, 2.0, 2.3, 2.4, 2.45, 2.6, 3.6, 2.6, 2.7, 2.9, 2.8, 3.4],
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Investment Total', style: TextStyle(color: Colors.blueAccent)),
                      Text('2.120.000 IDR', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                    ],
                  ),
                  Material
                  (
                      ...
                      (
                        ...
                        [
                          ...
                          (
                            ...
                            children: <Widget>
                            [
                              Text('Return', style: TextStyle(color: Colors.green)),
                              Text('IDR 300.000', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0)),
                            ],
                          ),
                          DropdownButton
                          (
              ...
              (
                ...
                [
                  ...
                  (
                    ...
                    children: <Widget>
                    [
                      Text('Reksa Dana Products', style: TextStyle(color: Colors.redAccent)),
                      Text('3', style: TextStyle(color: Colors.black, fontWeight: FontWeight.w700, fontSize: 34.0))
                    ],
                  ),
                  Material
                  (
